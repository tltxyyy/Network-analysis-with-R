...
### amazon-meta data
As one can see, the data format of amazon-meta resembles that of Javascript and needs to be firstly processed and reshaped to conduct any form on analysis.
